defmodule More.Mud.Supervision.PlayerSupervisor do
  @moduledoc """
  Supervisor for all player entities.

  Strategy: :one_for_one
  Restart: :permanent (players are critical, always restart)
  """
  ...
  def start_link(opts) do
    Logger.info("Starting Player Supervisor")
    Supervisor.start_link(__MODULE__, opts, name: __MODULE__)
  end

  @impl true
  def init(_opts) do
    Logger.info("Initializing Player Supervisor")
  ...
  @doc """
  Starts a new player entity.
  """
  def start_player(entity_id, entity_type, components) do
    child_spec = %{
      id: entity_id,
      start:
  ...
  @doc """
  Stops a player entity.
  """
  def stop_player(entity_id) do
